...
| 5 | Operating policies decided by the Owner/Operations (BL-002): hours and staffing, response targets, roles/specialist contacts, recovery procedure, retention/exports/complaints, notification channel | `OPERATIONS.md` — decided by the Owner on 2026-09-14 (DEC-0039) and in the product since PH-10, except retention (pending legal advice) and the e-mail provider; an internal demo may proceed with them pending only when the Owner confirms that in the release record (FND-0063) |
