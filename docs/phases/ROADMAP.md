...
| PH-10 | Operating policies in the product (DEC-0039): 24/7 schedule, times shown in the customer's time zone, formal complaints (customer topic, supervisor, 5 business days), admin export of a customer's data on request, recovery forwarded to the Verification team | OBJ-SUP-03, -04; RULE-SUP-01, -08, -09; BL-002 | `PLANNED` | PH-9, DEC-0039 |
