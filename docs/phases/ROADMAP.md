...
## Active chain
Phase: PH-6 `ACTIVE` since 2026-09-14 (`PH-6.md`) — PH-6.1 `APPROVED` 2026-09-14 (`PH-6.1.md`, evidence `../evidence/PH-6.1-verification.md`); next PH-6.2 (e-mail through a boundary port). PH-1..PH-5 `APPROVED`. Cycle 2 ledger: 2/3 — PH-6's approval triggers Cycle Audit 2. PH-1..PH-4 `APPROVED` (PH-4 evidence `../evidence/PH-4-phase-approval.md`). Cycle 2 ledger: 1/3. PH-1, PH-2 and PH-3 `APPROVED` 2026-09-13 (evidence `../evidence/PH-1-phase-approval.md`, `../evidence/PH-2-phase-approval.md`, `../evidence/PH-3-phase-approval.md`). Cycle Audit 1 CLOSED 2026-09-14 (`../audits/CYCLE-1.md`, remediation evidence `../evidence/CYCLE-1-verification.md`).
