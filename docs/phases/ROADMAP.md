...
## Active chain
Phase: PH-2 `ACTIVE` (since 2026-09-13, `PH-2.md`). Subphase: none active — PH-2.1 `APPROVED` 2026-09-13; next PH-2.2. PH-1 `APPROVED` 2026-09-13 (`PH-1.md`, evidence `../evidence/PH-1-phase-approval.md`).
