...
| PH-12 | Project closure (Owner, 2026-09-14: close everything except PH-11): the last Agent-owned debt (BL-017, BL-027, BL-028, BL-030), a closing audit of PH-10 and PH-12.1, the PH-11 brief for a GPT build, the internal demo release v0.2.0-demo, the closure record (`PH-12.md`) | all; RULE-SUP-03; §4.5, §7.5, §12.1 | `ACTIVE` | PH-10 |
...
## Active chain
Phase: PH-12 `ACTIVE` (`PH-12.md`, project closure) — PH-12.1 (closable debt, `../evidence/PH-12.1-verification.md`) approved; PH-12.2 (closing audit `../audits/CLOSING.md`, out of band — the ledger stays at 1/3; remediation `../evidence/CLOSING-verification.md`) closed; next PH-12.3 (hand-over: demo release v0.2.0-demo, closure record, PH-12 approval → cycle 4 at 2/3). PH-1..PH-10 `APPROVED`; every cycle audit through cycle 3 is CLOSED. PH-11 (AI assistant first line) stays `PLANNED`: the Owner builds it directly with GPT from `PH-11.md`, and its first approval brings cycle 4 to 3/3, which makes Cycle Audit 4 due (`PH-12.md` "After closure"). Internal demos: `v0.1.0-demo` (superseded), `v0.1.1-demo` (`../evidence/RELEASE-2026-09-14b.md`). A production release still needs the Owner (§1.1), Orbit's adapters (BL-001) and the two open policies (retention, e-mail provider — BL-002). The ledger table below is the only owner of the audit count.
