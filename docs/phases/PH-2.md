...
| PH-2.2 | Delivery and unread states: read markers, unread counts in lists, connection indicator, pending queue with retry on reconnect, sent/failed semantics documented | PLANNED |
