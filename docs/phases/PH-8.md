...
| PH-8.3 | Deployment and runbooks: containers, compose rehearsal, environment reference, release and operations runbooks; phase closure — `PH-8.3.md` (approval withdrawn 2026-09-14, FND-0062) | ACTIVE |
...
Approved 2026-09-14 and **withdrawn** the same day by the cycle 3 out-of-band audit (`../audits/CYCLE-3-OOB.md`, FND-0062): scenario (c) was never executed and the web image could not have built (FND-0058, now fixed). The phase completes when the compose rehearsal runs on a host with a working Docker engine and is recorded in `../evidence/PH-8.3-verification.md`; the earlier record `../evidence/PH-8-phase-approval.md` is kept as history.
Findings: FND-0058..FND-0081 (out-of-band audit), fixed, documented or carried (BL-026..BL-030).
Context updated: `ROADMAP.md` ledger (cycle 3 back to 1/3); `../../CURRENT_STATE.md`; DEC-0031–DEC-0034.
