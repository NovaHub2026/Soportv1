...
| PH-8.3 | Deployment and runbooks: containers, compose rehearsal, environment reference, release and operations runbooks; phase closure — `PH-8.3.md`, re-approved 2026-09-14 after the rehearsal | APPROVED |
...
Approved 2026-09-14, withdrawn the same day by the cycle 3 out-of-band audit (`../audits/CYCLE-3-OOB.md`, FND-0062), and **re-approved** on 2026-09-14 once scenario (c) ran: the images built from the corrected Dockerfiles, `docker compose up` reached a healthy PostgreSQL + API + web, `/api/health` answered `postgres (server)` through the web, the data survived a restart, and the api suites passed on a local PostgreSQL 16 (`../evidence/PH-8.3-verification.md`, `../evidence/PH-8.2-verification.md`, `../evidence/PH-8-phase-approval.md` "Re-approval").
Findings: FND-0058..FND-0081 (out-of-band audit), fixed, documented or carried (BL-026..BL-030).
Context updated: `ROADMAP.md` ledger (cycle 3 → 2/3); `../../CURRENT_STATE.md`; DEC-0031–DEC-0034.
