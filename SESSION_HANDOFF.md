...
## Unfinished work
PH-4 is `ACTIVE` with PH-4.1 and PH-4.2 approved; PH-4.3 (unavailable/not-found flows in the smoke, masking review, phase closure) is the next block — plan it in `docs/phases/PH-4.3.md` (to be created) before coding (see `CURRENT_STATE.md`). Carried audit items live in `docs/BACKLOG.md` BL-011..BL-019 with their revisit events.

## Evidence and limits
- `docs/evidence/PH-4.2-verification.md` (gate, build, browser smoke with "record-entry", "record-staff", "record-continue"; CI verdict for the PH-4.2 commit recorded there when available). PH-4.1: `docs/evidence/PH-4.1-verification.md` (CI green). Cycle Audit 1: `docs/evidence/CYCLE-1-verification.md` (CI green).
