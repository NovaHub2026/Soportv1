...
- Local integration demo: `npm run build` then `node scripts/demo-integration.mjs` — the real `optaqode` adapters and the embedded panel against a simulated broker on 127.0.0.1:3005 (mechanics only; `docs/runbooks/DEPLOYMENT.md`).
