...
| Controls | `scripts/check-context.mjs`, `scripts/gate-commit.sh`, `scripts/demo-local.mjs` | Link + lifecycle consistency (limits in the script header); gate-then-commit; loopback demo with post-release checks |
| Evidence | `docs/evidence/` | One record per work item or material run, e.g. `docs/evidence/PH-1.1-verification.md`; audit remediation in `docs/evidence/CYCLE-1-verification.md`, `docs/evidence/CYCLE-2-verification.md`; release records `docs/evidence/RELEASE-2026-09-14.md` (internal demo `v0.1.0-demo`) |
| Audits | `docs/audits/` | `CYCLE-1.md`, `CYCLE-2.md` (both closed 2026-09-14); one record per cycle |
