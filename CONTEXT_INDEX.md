...
| FEAT-ACCESS | Access recovery and privacy — não consigo acessar minha conta, recuperação de acesso, contato não verificado, permissões, papéis, sair, dispositivo compartilhado, sign-out | `docs/features/FEAT-ACCESS/CONTEXT.md` | RULE-SUP-01, -04 | `apps/api/src/access/`, `packages/shared/src/access.ts`, `apps/web/src/features/access/` (to be created in PH-7) | depends on FEAT-ORBIT identity boundary; used by the host shell and the staff workspace; PH-7 |
