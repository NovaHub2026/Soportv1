...
| FEAT-ORBIT | Orbit context integration — identidade, sessão, registros, saque, depósito, operação, retiro, diretório de atendentes, staff directory, papéis, roles | `docs/features/FEAT-ORBIT/CONTEXT.md` | RULE-SUP-01, -05, -07 | `apps/api/src/identity/`, `packages/shared/src/identity.ts` | used by every guarded surface; records arrive in PH-4 |
