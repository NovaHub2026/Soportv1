...
export const ptBR = {
  ...
  access: {
    ...
    nextStep: "Próximo passo: a equipe entra em contato pelo canal informado e conduz a recuperação pelo processo de verificação do Orbit. Guarde a referência acima para acompanhar.",
    back: "Voltar",
  ...
  staff: {
    ...
    accessRecovery: {
      ...
      intro: "Pedidos de quem não consegue entrar: um contato não verificado e uma descrição. Nenhum pedido está ligado a uma conta — retorne pelo contato informado e conduza pelo processo de verificação do Orbit.",
      ...
      filter: "Mostrar",
      all: "Todos",
      statuses: { received: "Recebido", forwarded: "Encaminhado", closed: "Encerrado" },
      contact: "Contato",
      note: "Observação (opcional)",
      forward: "Encaminhar ao processo de verificação",
      close: "Encerrar",
      forwardHint: "O encaminhamento ao Orbit é simulado nesta versão: fica registrado quem encaminhou e quando.",
      forwardedDone: "{reference} encaminhado ao processo de verificação (simulação).",
