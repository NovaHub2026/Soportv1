...
| Integration / CI / release | Candidate: the re-approval commit (docs only after `a863593`); CI verdict recorded in `docs/evidence/PH-8.3-verification.md` when known. `a863593` CI success (both jobs). Release: `v0.1.1-demo`, internal loopback demo; no production release authorized. |
...
Preconditions: CI green on the re-approval commit (record it in `docs/evidence/PH-8.3-verification.md`).
